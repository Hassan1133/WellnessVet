...
import com.wellness.vet.app.activities.doctor.DoctorUserPetsActivity
import com.wellness.vet.app.models.DoctorAppointmentListModel
import com.wellness.vet.app.models.FarmModel

class DoctorUserFarmsListAdp(
    private val context: Activity,
    private var farmsList: List<FarmModel>,
    private val appointmentModel: DoctorAppointmentListModel
) :
    RecyclerView.Adapter<DoctorUserFarmsListAdp.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener{
            val intent = Intent(context, DoctorUserPetsActivity::class.java)
