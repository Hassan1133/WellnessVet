...
import com.wellness.vet.app.activities.common.MainTestAuthActivity;
...
public class PaymentActivity extends AppCompatActivity {
    ...
    private final String Jazz_MerchantID      = "MC92163";
    private final String Jazz_Password        = "18y4vwd3v2";
    private final String Jazz_IntegritySalt   = "sbt7e1015z";
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            System.out.println("AhmadLogs: pay url cancelling");
            if(url.equals(paymentReturnUrl)){
                System.out.println("AhmadLogs: pay url cancelling");
                return;
            }
    ...
    private class FormDataInterface {
        ...
        public void processFormData(String url, String formData) {
            Intent i = new Intent(PaymentActivity.this, MainTestAuthActivity.class);
